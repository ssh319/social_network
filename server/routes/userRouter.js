...
router.get("/", /* validateSearchQuery */ controller.searchUsers);
...
router.post("/friends/:id", authenticate, validateUserId, controller.addFriend);
router.patch("/friends/:id", authenticate, validateUserId, controller.acceptFriend);
router.delete("/friends/:id", authenticate, validateUserId, controller.removeFriend);
